...
void f3(void *arg)
{
  ...
  18:	b9450513          	addi	a0,a0,-1132 # ba8 <thread_start_threading+0x34>
  1c:	00000097          	auipc	ra,0x0
  20:	756080e7          	jalr	1878(ra) # 772 <printf>
  24:	71148493          	addi	s1,s1,1809
  28:	00001997          	auipc	s3,0x1
  2c:	b8098993          	addi	s3,s3,-1152 # ba8 <thread_start_threading+0x34>
        if(i == 10005){
  30:	6909                	lui	s2,0x2
  ...
  3a:	b06080e7          	jalr	-1274(ra) # b3c <thread_yield>
        printf("thread 3: %d\n", i++);
  3e:	85a6                	mv	a1,s1
...
void f2(void *arg)
{
  ...
  74:	b4850513          	addi	a0,a0,-1208 # bb8 <thread_start_threading+0x44>
  78:	00000097          	auipc	ra,0x0
  7c:	6fa080e7          	jalr	1786(ra) # 772 <printf>
  80:	4485                	li	s1,1
  82:	00001a17          	auipc	s4,0x1
  86:	b36a0a13          	addi	s4,s4,-1226 # bb8 <thread_start_threading+0x44>
        if (i == 10) {
  8a:	49a9                	li	s3,10
  ...
  94:	aac080e7          	jalr	-1364(ra) # b3c <thread_yield>
        printf("thread 2: %d\n",i++);
...
void f1(void *arg)
{
 ...
 102:	aca50513          	addi	a0,a0,-1334 # bc8 <thread_start_threading+0x54>
 106:	00000097          	auipc	ra,0x0
 10a:	66c080e7          	jalr	1644(ra) # 772 <printf>
 10e:	06500493          	li	s1,101
 112:	00001a17          	auipc	s4,0x1
 116:	ab6a0a13          	addi	s4,s4,-1354 # bc8 <thread_start_threading+0x54>
        if (i == 110) {
 ...
 126:	a1a080e7          	jalr	-1510(ra) # b3c <thread_yield>
        printf("thread 1: %d\n", i++);
...
int main(int argc, char **argv)
{
 ...
 16e:	a0a080e7          	jalr	-1526(ra) # b74 <thread_start_threading>
    printf("\nexited\n");
 172:	00001517          	auipc	a0,0x1
 176:	a6650513          	addi	a0,a0,-1434 # bd8 <thread_start_threading+0x64>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ee:	4fe90913          	addi	s2,s2,1278 # be8 <thread_start_threading+0x74>
        while(*s != 0){
...
void thread_add_runqueue(struct thread *t){
 ...
 9fe:	f15c                	sd	a5,160(a0)
        t->previous = current_thread->previous;
 a00:	6fd8                	ld	a4,152(a5)
 a02:	ed58                	sd	a4,152(a0)
        current_thread->previous->next = t;
 a04:	f348                	sd	a0,160(a4)
 ...
 a12:	20a7b123          	sd	a0,514(a5) # c10 <current_thread>
        current_thread->next = current_thread->previous = t;
 a16:	ed48                	sd	a0,152(a0)
...
void schedule(void){
 ...
 a26:	1ee78793          	addi	a5,a5,494 # c10 <current_thread>
 a2a:	6398                	ld	a4,0(a5)
...
void thread_exit(void){
 ...
 a44:	1d04b483          	ld	s1,464(s1) # c10 <current_thread>
 a48:	70dc                	ld	a5,160(s1)
 a4a:	02f48e63          	beq	s1,a5,a86 <thread_exit+0x50>
        // TODO
        struct thread *t = current_thread;
        t->previous->next = t->next;
 a4e:	6cd8                	ld	a4,152(s1)
 a50:	f35c                	sd	a5,160(a4)
        t->next->previous = t->previous;
 a52:	6cd8                	ld	a4,152(s1)
 a54:	efd8                	sd	a4,152(a5)
        current_thread = t->next;
 a56:	70dc                	ld	a5,160(s1)
 a58:	00000717          	auipc	a4,0x0
 a5c:	1af73c23          	sd	a5,440(a4) # c10 <current_thread>
        free(t->stack);
 ...
 a78:	040080e7          	jalr	64(ra) # ab4 <dispatch>
 ...
 a84:	8082                	ret
        free(current_thread->stack);
 a86:	6888                	ld	a0,16(s1)
 a88:	00000097          	auipc	ra,0x0
 a8c:	d20080e7          	jalr	-736(ra) # 7a8 <free>
        free(current_thread);
 a90:	00000517          	auipc	a0,0x0
 a94:	18053503          	ld	a0,384(a0) # c10 <current_thread>
 a98:	00000097          	auipc	ra,0x0
 a9c:	d10080e7          	jalr	-752(ra) # 7a8 <free>
        longjmp(env_st, 1);
 aa0:	4585                	li	a1,1
 aa2:	00000517          	auipc	a0,0x0
 aa6:	18650513          	addi	a0,a0,390 # c28 <env_st>
 aaa:	00000097          	auipc	ra,0x0
 aae:	ea2080e7          	jalr	-350(ra) # 94c <longjmp>
}
 ab2:	b7e9                	j	a7c <thread_exit+0x46>
...
void dispatch(void){
 ...
 ac0:	1547b783          	ld	a5,340(a5) # c10 <current_thread>
 ac4:	0947a703          	lw	a4,148(a5)
 ac8:	eb05                	bnez	a4,af8 <dispatch+0x44>
        current_thread->buf_set = 1;
 aca:	4705                	li	a4,1
 acc:	08e7aa23          	sw	a4,148(a5)
        if (setjmp(env_tmp) == 0){
 ad0:	00000517          	auipc	a0,0x0
 ad4:	1c850513          	addi	a0,a0,456 # c98 <env_tmp>
 ad8:	00000097          	auipc	ra,0x0
 adc:	e3c080e7          	jalr	-452(ra) # 914 <setjmp>
 ae0:	c91d                	beqz	a0,b16 <dispatch+0x62>
        (*(current_thread->fp))(current_thread->arg);
 ae2:	00000797          	auipc	a5,0x0
 ae6:	12e7b783          	ld	a5,302(a5) # c10 <current_thread>
 aea:	6398                	ld	a4,0(a5)
 aec:	6788                	ld	a0,8(a5)
 aee:	9702                	jalr	a4
        thread_exit();
 af0:	00000097          	auipc	ra,0x0
 af4:	f46080e7          	jalr	-186(ra) # a36 <thread_exit>
    longjmp(current_thread->env, 1);
 af8:	4585                	li	a1,1
 afa:	00000517          	auipc	a0,0x0
 afe:	11653503          	ld	a0,278(a0) # c10 <current_thread>
 b02:	02050513          	addi	a0,a0,32
 b06:	00000097          	auipc	ra,0x0
 b0a:	e46080e7          	jalr	-442(ra) # 94c <longjmp>
}
 b0e:	60a2                	ld	ra,8(sp)
 b10:	6402                	ld	s0,0(sp)
 ...
 b1a:	0fa7b783          	ld	a5,250(a5) # c10 <current_thread>
 b1e:	6f9c                	ld	a5,24(a5)
 b20:	00000717          	auipc	a4,0x0
 b24:	1ef73023          	sd	a5,480(a4) # d00 <env_tmp+0x68>
            longjmp(env_tmp, 1);
 b28:	4585                	li	a1,1
 b2a:	00000517          	auipc	a0,0x0
 b2e:	16e50513          	addi	a0,a0,366 # c98 <env_tmp>
 b32:	00000097          	auipc	ra,0x0
 b36:	e1a080e7          	jalr	-486(ra) # 94c <longjmp>
 b3a:	b765                	j	ae2 <dispatch+0x2e>

0000000000000b3c <thread_yield>:
void thread_yield(void){
 ...
 b48:	0cc53503          	ld	a0,204(a0) # c10 <current_thread>
 b4c:	02050513          	addi	a0,a0,32
 b50:	00000097          	auipc	ra,0x0
 b54:	dc4080e7          	jalr	-572(ra) # 914 <setjmp>
 b58:	c509                	beqz	a0,b62 <thread_yield+0x26>
}
 b5a:	60a2                	ld	ra,8(sp)
 b5c:	6402                	ld	s0,0(sp)
 ...
 b66:	eba080e7          	jalr	-326(ra) # a1c <schedule>
        dispatch();
 b6a:	00000097          	auipc	ra,0x0
 b6e:	f4a080e7          	jalr	-182(ra) # ab4 <dispatch>
}
 b72:	b7e5                	j	b5a <thread_yield+0x1e>

0000000000000b74 <thread_start_threading>:
void thread_start_threading(void){
 ...
 b80:	0ac50513          	addi	a0,a0,172 # c28 <env_st>
 b84:	00000097          	auipc	ra,0x0
 b88:	d90080e7          	jalr	-624(ra) # 914 <setjmp>
 b8c:	c509                	beqz	a0,b96 <thread_start_threading+0x22>
        schedule();
        dispatch();
    }
}
 ...
 b9a:	e86080e7          	jalr	-378(ra) # a1c <schedule>
        dispatch();
 b9e:	00000097          	auipc	ra,0x0
 ba2:	f16080e7          	jalr	-234(ra) # ab4 <dispatch>
}
 ba6:	b7e5                	j	b8e <thread_start_threading+0x1a>
