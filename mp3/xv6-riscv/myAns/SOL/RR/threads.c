...
void schedule(void){
    ...
    else if (current_thread->is_exited == 1 || current_thread->is_yield == 1 || --current_thread->remain_time_quantum == 0)
    {
        current_thread->remain_time_quantum = 3;
